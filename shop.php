    ...
    <header class="p-3 mb-3 border-bottom">
      <div class="container">
        ...
        >
          ...
          <ul
            class="nav col-12 col-lg-auto ms-3 me-lg-auto mb-2 justify-content-center mb-md-0"
          >
            <li>
              <a href="shop.html" class="nav-link px-2 link-secondary">Buy</a>
            </li>
            <li>
              <a href="sell.html" class="nav-link px-2 link-dark">Sell</a>
            </li>
          </ul>
          <div class="dropdown text-end">
            ...
            >
              <img
                src="assets/img/rabia-profile.png"
                alt="mdo"
          ...
          <div class="navbar navbar-light navbar-expand">
            <ul class="nav navbar-nav mega-menu">
              <li class="nav-item dropdown" data-category-id="1">
                <a
                  id="nav_main_category_1"
                  href="https://www.beopari.pk/goat"
              ...
              <li class="nav-item dropdown" data-category-id="2">
                <a
                  ...
                  href="https://www.beopari.pk/Cattle"
                  class="nav-link dropdown-toggle nav-main-category"
                  data-id="2"
                  data-parent-id="0"
                  data-has-sb="0"
              ...
              <li class="nav-item dropdown" data-category-id="3">
                <a
                  ...
                  href="https://www.beopari.pk/sheep"
                  class="nav-link dropdown-toggle nav-main-category"
                  data-id="3"
                  data-parent-id="0"
                  data-has-sb="0"
              ...
              <li class="nav-item dropdown" data-category-id="4">
                <a
                  id="nav_main_category_4"
                  href="https://www.beopari.pk/chicken"
                  class="nav-link dropdown-toggle nav-main-category"
                  data-id="4"
                  data-parent-id="0"
                  data-has-sb="0"
              ...
              <li class="nav-item dropdown" data-category-id="5">
                <a
                  id="nav_main_category_5"
                  href="https://www.beopari.pk/horse"
                  class="nav-link dropdown-toggle nav-main-category"
                  data-id="5"
                  data-parent-id="0"
                  data-has-sb="0"
              ...
              <li class="nav-item dropdown" data-category-id="6">
                <a
                  id="nav_main_category_6"
                  href="https://www.beopari.pk/cat"
                  class="nav-link dropdown-toggle nav-main-category"
                  data-id="6"
                  data-parent-id="0"
                  data-has-sb="0"
